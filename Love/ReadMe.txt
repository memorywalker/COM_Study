...
应用程序向导已为您创建了此 Love 项目，作为编写动态链接库 (DLL) 
的起点。
...
StdAfx.h，StdAfx.cpp
    这些文件用于生成名为 Love.pch 的预编译头 (PCH) 文件和
...
Loveps.vcxproj
    ...
    文件。此进程生成 dlldata.c、Love_i.c 和 
    Love_p.c，这些文件是生成代理/存根 (stub) DLL 所必需的。

Loveps.vcxproj.filters
